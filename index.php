...
<body>
   ...
   ?>
   <div class="banner_section layout_padding" style="background-image: url(admin/<?php echo $Carouselrow['video_thumbnail'] ?>);background-repeat: no-repeat;background-size:100vw 100vh;" class="img-fluid">
      <div class="container">
         <div class="row">
...
border: 1px solid rgba(255, 255, 255, 0.49);">
            ...
            <div class="col-md-6">
               <div class="play_icon"><a href="playvideo.php?id=<?php echo $Carouselrow['id'] ?>"><img src="images/play-icon.png"></a></div>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="movies_section layout_padding" style="background-color: black;">
      <div class="container">
         <div class="movies_section_2 layout_padding">
            <h2 class="letest_text">Latest Music<span class="badge rounded-pill  mx-2 text-bg-primary" style="background-color:#138808 ;color:white;border-radius: 40%;">New</span>
            </h2>
               ...
               <div class="iamge_movies_main">
                  ...
                  ?>
                        <div class="iamge_movies">
                           <div class="image_3">
                              <img src="admin/<?php echo $musicrow['music_thumbnail'] ?>" class="image img-fluid" style="width:100%;aspect-ratio: 3/4; object-fit: contain;">
                              <div class="middle">
                                 <div class="playnow_bt" style="background-color: green;"><a href="playmusic.php?id=<?php echo $musicrow['id'] ?>" style="cursor: pointer;color: white;">Play Now</a></div>
                              </div>
                           </div>
         ...
         <div class="movies_section_2 layout_padding">
            <h2 class="letest_text">Latest Video<span class="badge rounded-pill  mx-2 text-bg-primary" style="background-color:#138808 ;color:white;border-radius: 40%;">New</span></h2>
            ...
            <div class="movies_main">
               <div class="iamge_movies_main">
                  ...
                  ?>
                        <div class="iamge_movies">
                           <div class="image_3">
                              <img src="admin/<?php echo $videorow['video_thumbnail'] ?>" class="image" style="width:100%;aspect-ratio: 1/1;">
                              <div class="middle">
                                 <div class="playnow_bt" style="background-color: green;"><a href="playvideo.php?id=<?php echo $videorow['id'] ?>" style="cursor: pointer;color: white;">Play Now</a></div>
                              </div>
                           </div>
