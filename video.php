...
<body style="background-color: black;">
    ...
    <div class="container-fluid my-4">
        ...
        <div class="row">
          ...
          WHERE video.video_artist IN (  
              SELECT id FROM video_artist  
              WHERE video_artist.artist_name LIKE '%" . $_GET['query'] . "%'  
          ) OR video.video_title LIKE '%" . $_GET['query'] . "%'  
          OR video.release_date LIKE '%" . $_GET['query'] . "%'";
            } else {
                $query = "SELECT video.*, video_artist.artist_name, videogenre.`video_genre_name`
                FROM video
                INNER JOIN video_artist ON video.video_artist = video_artist.id
