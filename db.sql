...
(3,'video/Japan Earthquake, Tsunami and Plane Crash _ Why is it happening_ _ Dhruv Rathee.mp4','8','thumbnail/druv.jpg','Japan Earthquake ','December 12 2022','3','In this eye opening video we explore the catastrophic impact of the powerful earthquake that hit central Japan on January 1 2024 and the subsequent tsunamis it triggered We delve deep into the geology that  makes Japan particularly susceptible to such natural disasters examining the nations proactive disasterprevention measures and the resilient response of its people'),
(4,'video/AI & ML Roadmap - Complete Roadmap for Machine Learning PDF Download? (1).mp4','9','thumbnail/harry meachine learningjpg.jpg','AI and ML Roadmap for Machine Learning','April 24 2024','5','A comprehansive Roadmap for machine learning with essential tools and resources'),
...
(7,'video/Best tutorial docs that you have seen.mp4','10','thumbnail/chai 4.jpg','Best tutorial docs that you have seen','May 28 2024','5','Welcome to chai aur code a coding programming dedicated channel in Hindi language Now you can learn best of programming concepts with industry standard practical guide in Hindi language'),
(8,'video/Launching Masterji Platform for coding projects with code reviews.mp4','10','thumbnail/chai 1.jpg','Launching Masterji Platform for coding projects with code reviews','july 22 2024','5','A new Software platform has been launched to enhance the coding projects managment and code review'),
...
(10,'video/I Built 100 Wells In Africa.mp4','7','thumbnail/mister1.jpg','I Built 100 Wells In Africa','Nov 4 2023','3','Constructed 100 wells in Africa to providing clean water beacuse access of clean water is not their'),
(11,'video/I Cleaned The World’s Dirtiest Beach TeamSeas.mp4','7','thumbnail/beast4.jpg','I cleaned worlds dirtiest beach','April 24 2024','4','this video mr beast and group of volunteers clean the one of worlds dirtiest beach removing 60000 trash');
