...
// if (move_uploaded_file($tempvideo_name, $video)) {
// $tempvideo_thumbnail = $_FILES['video_thumbnail']['tmp_name'];
// $thumbfilename = $_FILES['video_thumbnail']['name'];
// $thumbnail = "thumbnail/$thumbfilename";
// if (move_uploaded_file($tempvideo_thumbnail, $thumbnail)) {
// $video_artist = $_POST['video_artist'];
// $video_title = $_POST['video_title'];
...
// (video_loc,video_thumbnail,video_title,video_genre,video_description,release_date,video_artist) VALUES ('" . $video .
// "','" . $video_thumbnail . "','" . $video_title . "','" . $video_genre . "','" . $video_description . "','" .
// $release_date . "','" . $video_artist . "')";
// // $result = mysqli_query($connection, $query);
// // if ($result) {
// // header("Location:video.php?msg=Video Added successfully");
// // } else {
