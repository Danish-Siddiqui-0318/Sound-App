                    ...
                    <div class="col-md-4 my-5">
                        <div class="card"
                            ...
                            <div class="card-details ">
                                ...
                                <p class="text-white text-capitalize" style="font-weight: bolder;">Album Name <?php echo $row['album_name'] ?></p>
                            </div>
                            <button class="card-button"><a href="" class="text-white">More info</a></button>
                        </div>
                    </div>
                    <?php
                }
